...
If this stage is skipped (has SKIP.md), execute the next non-skipped stage's agent skill. Otherwise, create the file `00-init-ideas/README.md` with the following content:
